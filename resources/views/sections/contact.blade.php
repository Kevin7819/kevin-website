...
<section id="contacto" class="py-20 fade-in-section">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <h2 class="text-4xl sm:text-5xl font-extrabold mb-4 text-left">
            <span class="gradient-text">{{ $content[$lang]['contact']['title'] }}</span>
        </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-4 bg-portfolio-card border border-portfolio-border/50 rounded-2xl p-5">
                    ...
                    <div>
                        <p class="text-portfolio-text font-semibold">{{ $content[$lang]['contact']['form']['email'] }}</p>
                        <p class="text-portfolio-dim text-sm">{{ $content[$lang]['contact']['use_form'] }}</p>
                    </div>
                </div>
                ...
                <a href="https://www.linkedin.com/in/kevin-venegas-berm%C3%BAdez/"
                    ...
                    <div>
                        ...
                        <p class="text-portfolio-dim text-sm">{{ $content[$lang]['contact']['linkedin'] }}</p>
                    </div>
                </a>
                ...
                <a href="https://github.com/Kevin7819"
                    ...
                    <div>
                        <p class="text-portfolio-text font-semibold group-hover:text-portfolio-accent transition-colors">GitHub</p>
                        <p class="text-portfolio-dim text-sm">Kevin7819</p>
                    </div>
                </a>
                ...
                <div class="flex items-center gap-4 bg-portfolio-card border border-portfolio-border/50 rounded-2xl p-5">
                    ...
                    <div>
                        <p class="text-portfolio-text font-semibold">{{ $lang === 'es' ? 'Ubicación' : 'Location' }}</p>
            ...
            <div class="bg-portfolio-card border border-portfolio-border/50 rounded-2xl p-6 card-hover">
                @if(session('success'))
                    <div class="mb-5 p-4 bg-green-500/10 border border-green-500/30 rounded-xl text-green-400 text-sm">
                        ...
                        <strong>{{ $content[$lang]['contact']['form']['sent'] }}</strong>
                    </div>
                @endif
                ...
                <form action="{{ route('contact.send') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               name="name"
                               required
                               placeholder="{{ $content[$lang]['contact']['form']['name_placeholder'] }}"
                    ...
                    <div>
                        ...
                        <input type="email"
                               ...
                               name="email"
                               required
                               placeholder="{{ $content[$lang]['contact']['form']['email_placeholder'] }}"
                               class="w-full bg-portfolio-bg border border-portfolio-border/50 rounded-xl px-4 py-3 text-portfolio-text placeholder-portfolio-dim/50 focus:outline-none focus:border-portfolio-accent focus:ring-1 focus:ring-portfolio-accent transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="message"
                                  ...
                                  required
                                  rows="5"
                                  placeholder="{{ $content[$lang]['contact']['form']['message_placeholder'] }}"
